...
def housewife_detail(call):
    ...
    detail_text = (
        ...
        "📊 တစ်လတာ၏ ဝင်ငွေနှင့် အသုံးစရိတ်များကို ရှင်းလင်းစွာသိမြင်နိုင်ခြင်းကြောင့် အသုံးစရိတ်ချင့်ချိန်နိုင်ခြင်း\n"
        "🔒 ကိုယ်ပိုင် PIN စနစ်ဖြင့် လုံခြုံမှုပေးခြင်း\n"
        "✅ Offline (အင်တာနက်မလိုဘဲ) အသုံးပြုနိုင်ခြင်း\n\n"
